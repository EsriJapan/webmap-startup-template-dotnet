...
using WebMapApp.ViewModels;

// 基本ページのアイテム テンプレートについては、http://go.microsoft.com/fwlink/?LinkId=234237 を参照してください

namespace WebMapApp.Views
{
    /// <summary>
    /// 多くのアプリケーションに共通の特性を指定する基本ページ。
    /// </summary>
    public sealed partial class WebMapListView : Page
    {
        ...
        public WebMapListView()
        {
            this.InitializeComponent();

            //ビューモデルを作成しデータコンテキストに設定
            var vm = new WebMapListViewModel();
            this.DataContext = vm;
